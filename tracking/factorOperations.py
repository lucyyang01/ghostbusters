...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for eliminating_assignments in result.getAllPossibleAssignmentDicts():
            #print("here", eliminating_assignments)
            probability = 0
            for varValue in factor.variableDomainsDict()[eliminationVariable]:
                full_assignment = eliminating_assignments
                full_assignment[eliminationVariable] = varValue
